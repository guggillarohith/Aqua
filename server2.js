...
var forCronTdoFile = '/home/pi/do_data.txt'
var localDoLoc = '../do_data.txt'
var doFileLoc = localDoLoc //- allways chk to change the loc before pushing
...
var sync = function() {
  fs.readFile(doFileLoc, 'utf8',function (err, data) {
    // if (err) throw err;
    if (err || data == "") {
